...
function RegisterPage () {
  ...
  return (
    <div>
      <form
        className='max-w-sm mx-auto' onSubmit={handleSubmit(async (values) => {
          console.log(values)
      ...
      >
        ...
        <div className='relative'>
          <div className='absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none'>
            <svg className='-4 h-4 text-gray-500 dark:text-gray-400' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 20 16'>
